package com.keysight.utility;

import com.google.common.base.Function;
import com.keysight.drivermanager.ManageDriver;
...
public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "src/main/java/com/keysight/screenshots/";
...
public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "src/main/java/com/keysight/screenshots/" + screenshotName + dateName + ".png";
...
public void sendRandomEmail(WebElement element) {
        Random randomNum = new Random();
        int randomInt = randomNum.nextInt(1000);
        String email = "abxc" + randomInt + "@gmail.com";
...
public void clearValue(WebElement element) {
    ...
    public void acceptCookiesAndSwitchToIframe() throws InterruptedException {
        driver.switchTo().frame("//iframe[@id='pop-frame03310874013940044']");
        Thread.sleep(500);
        WebElement acceptCookies = driver.findElement(By.xpath("//a[text()='Agree and Proceed']"));
        acceptCookies.click();
    }
    }
